...
// UTEM
// Modelo Robot = speedBots

//------------------------------------------------------------------------------------------------------------------------------------------
//////////////////////////////////// Librerias /////////////////////////////////////////////////////////////////////////////////////////////
//------------------------------------------------------------------------------------------------------------------------------------------

#include "PinChangeInterrupt.h" /* Permiten la detección de cambios en los pines de entrada en un microcontrolador 
...
const int Ain2 = 8;
const int Ain1 = 7;
const int Bin1 = 13;      // Izquierda  
const int Bin2 = 12;
const int pwmB = 11;
const int sA = A0;
const int sB = A1;
const byte C1R = 3; // Entrada de la señal A del encoder (Cable verde).
const byte C2R = 2; // Entrada de la señal B del encoder (Cable amarillo). 
const byte C1L = 4; // Entrada de la señal A del encoder (Cable verde).
const byte C2L = 5; // Entrada de la señal B del encoder (Cable amarillo).
const int button = 10;
...
void setup() {
  ...
  qtr.setEmitterPin(9); // Especificar el pin al que está conectado el emisor de luz de los sensores de línea

//---------------------------------- CONFIGURACION DE PINES --------------------------------------------------------------------------------
  // Pin Encoder derecho
  pinMode(C1R, INPUT); pinMode(C2R, INPUT);

  // Pin Encoder izquierdo
  pinMode(C1L, INPUT); pinMode(C2L, INPUT);
